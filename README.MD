# Windy
This is **Windy**, a visualization of Wind conditions and airpressure over the Nordic and Baltic areas, using open 
...
stored into two json files: `msl.json` (air pressure) and `wind.json`. For implementation, see blog entry (link to be 
added).
...
The result is can be seen [here](https://www.viltstigen.se/windy/windy.html)
